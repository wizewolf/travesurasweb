						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								{{-- <div class="carousel-caption">
									<p>Disponemos de un salón amplio</p>
                ...
                <div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="head_title_rigth wow fadeInRight"  data-wow-duration="3s">
							<p class="esp">Realizamos fiestas personalizadas para su niño, contamos con todo lo necesario. Solo necesitamos tu idea de fiesta infantil y la hacemos realidad.</p>
						</div>
					</div><!-- End of col-sm-5 -->
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12  main_whatido_content text-center">
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="single_whatido wow fadeInDown"  data-wow-duration="1s">
								...
								<p class="info">Ofrecemos una amplia gama de motivos para festejar la fiesta soñada de tu hijo ya sea pelotero y servicio de catering. </p>
							</div>
						</div>
